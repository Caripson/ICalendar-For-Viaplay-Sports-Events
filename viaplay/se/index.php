...
echo("PRODID:-//Viaplay//Johan_Caripson//SV"."\r\n");
echo("VERSION:2.0"."\r\n");
echo("X-WR-CALNAME:Viaplay Sport Sweden"."\r\n");
echo("X-WR-TIMEZONE:Europe/Stockholm"."\r\n");
echo("X-WR-CALDESC:Viaplay Calender data from www.viaplay.se"."\r\n");
