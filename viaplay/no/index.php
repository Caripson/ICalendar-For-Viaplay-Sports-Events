...
$url = 'https://content.viaplay.no/pcdash-no/sport?date='.getStartAndEndDate($qdate);
...
echo("PRODID:-//Viaplay//Johan_Caripson//NO"."\r\n");
echo("VERSION:2.0"."\r\n");
echo("X-WR-CALNAME:Viaplay Sport Norway"."\r\n");
echo("X-WR-TIMEZONE:Europe/Oslo"."\r\n");
echo("X-WR-CALDESC:Viaplay Calender data from www.viaplay.no"."\r\n");
