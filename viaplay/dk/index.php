...
$url = 'https://content.viaplay.dk/pcdash-dk/sport?date='.getStartAndEndDate($qdate);
...
function traverse(&$objOrArray)
{
	...
	else
	{
  		...
  		if ($synopsis_status == true)
		{
			...
			//$synopsis =  str_split($synopsis,75)[0];

			echo("BEGIN:VEVENT" . "\r\n");
			echo("DTSTART:" . $streamStart . "Z\r\n" );
			echo("DTEND:" . $streamEnd  . "Z\r\n");
			echo("DTSTAMP:" . $streamStart . "Z\r\n");
			echo("CREATED:" . $streamStart . "Z\r\n");
			echo("DESCRIPTION:" .  $synopsis  . "\r\n");
			echo("LAST-MODIFIED:". $streamStart . "Z\r\n");
			echo("LOCATION:" . "\r\n");
			echo("SEQUENCE:0" . "\r\n");
...
echo("PRODID:-//Viaplay//Johan_Caripson//DK"."\r\n");
echo("VERSION:2.0"."\r\n");
echo("X-WR-CALNAME:Viaplay Sport Denmark"."\r\n");
echo("X-WR-TIMEZONE:Europe/Copenhagen"."\r\n");
echo("X-WR-CALDESC:Viaplay Kalenderdata fra www.viaplay.se"."\r\n");
